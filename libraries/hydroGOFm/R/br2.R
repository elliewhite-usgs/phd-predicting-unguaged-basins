# Ellie's comment: gof function in the HydroGOF package has an error when calculating bR2, fixed it here! 
...
br2.default <- function (sim, obs, na.rm=TRUE, ...){
     ...
     br2 <- ifelse(abs(b) <= 1, r2*abs(b), r2/abs(b)) # here was the error!!! changed b<=1 to abs(b)<=1
